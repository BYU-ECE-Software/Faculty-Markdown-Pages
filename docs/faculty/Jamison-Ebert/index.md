...
=== "Overview"
    ...
    <div style="text-align: center;">
        <img src="images/ebert.jpg" alt="Jamison Ebert" style="width:400px;"/>
    </div>
...
=== "Publications"
    ...
    [Google Scholar](https://scholar.google.com/citations?user=fcxlpRIAAAAJ&hl=en&oi=ao) 


    ### Selected Articles
    - ["Linked-Loop Codes for the Unsourced A- and B-Channels with Erasures"](https://doi.org/10.1109/TCOMM.2025.3604325), *IEEE Transactions on Communications*, 2025.
    - ["Sparse Regression LDPC Codes"](https://doi.org/10.1109/TIT.2024.3496486), *IEEE Transactions on Information Theory*, 2025.
    - ["Coded Demixing for Unsourced Random Access"](https://doi.org/10.1109/TSP.2022.3182224), *IEEE Transactions on Signal Processing*, 2022.
    - ["An Enhanced Decoding Algorithm for Coded Compressed Sensing with Applications to Unsourced Random Access"](https://doi.org/10.3390/s22020676), *Sensors*, 2022.
